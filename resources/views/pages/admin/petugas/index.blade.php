            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header border-0 d-flex justify-content-between">
                        ...
                        <a href="{{ route('petugas.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah
                            Petugas</a>
                    </div>
                    <!-- Light table -->
                        ...
                        <table class="table align-items-center table-flush" id="pengaduanTable">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col" class="sort" data-sort="perumahan">Perumahan</th>
                            ...
                            <tbody class="list">
                                @foreach ($petugas as $k => $pet)
                                    <tr>
                                        ...
                                        <td><span
                                                class="text-sm">{{ $pet->perumahan->nama_perumahan ?? 'Tidak Ada' }}</span>
                                        </td> <!-- Tambahkan ini -->
                                        <td><span class="text-sm">{{ $pet->roles }}</span></td>
                                        <td style="width: 100px;">
                                            <a href="{{ route('petugas.edit', $pet->id_petugas) }}"
                                                class="btn btn-sm btn-warning">Edit</a>
                                            <a href="#" data-id_petugas="{{ $pet->id_petugas }}"
                                                class="btn btn-sm btn-danger petugasDelete">Hapus</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
