                        ...
                        <table class="table align-items-center table-flush" id="pengaduanTable">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col" class="sort" data-sort="name">Perumahan</th>
                            ...
                            <tbody class="list">
                                @foreach ($masyarakat as $k => $mas)
                                    <tr>
                                        ...
                                        <td><span
                                                class="text-sm">{{ $mas->perumahan ? $mas->perumahan->nama_perumahan : '-' }}</span>
                                        </td>
                                        <td><span class="text-sm">{{ $mas->username }}</span></td>
                                        <td><span class="text-sm">{{ $mas->telp }}</span></td>
                                        <td style="width: 100px;">
                                            <a href="{{ route('masyarakat.show', $mas->nik) }}"
                                                class="btn btn-sm btn-info">Detail</a>
                                            <a href="#" data-nik="{{ $mas->nik }}"
                                                class="btn btn-sm btn-danger masyarakatDelete">Hapus</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
